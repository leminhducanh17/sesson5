...
SELECT 
    ...
    LanCuoiMuaHang,
    CASE
        WHEN TongChiTieu > 10000000 AND SoDonHang >= 10 THEN 'VIP'
        WHEN ThanhPho = 'Hà Nội' AND SoDonHang < 5 AND TongChiTieu > 2000000 THEN 'Tiềm năng'
        WHEN LanCuoiMuaHang < '2023-09-01' THEN 'Cần hâm nóng'
        ELSE 'Khác'
    END AS PhanLoai
FROM KhachHangThanThiet
ORDER BY PhanLoai;
